...
/**
 * REST controller for managing {@link br.com.ngzorro.domain.Fornecedor}.
 */
@RestController
@RequestMapping("/api")
public class FornecedorResource {
    ...
    public ResponseEntity<FornecedorDTO> createFornecedor(@RequestBody FornecedorDTO fornecedorDTO) throws URISyntaxException {
    ...
    public ResponseEntity<FornecedorDTO> updateFornecedor(@RequestBody FornecedorDTO fornecedorDTO) throws URISyntaxException {
