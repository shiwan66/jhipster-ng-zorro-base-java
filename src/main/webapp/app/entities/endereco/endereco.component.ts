...
export class EnderecoComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.enderecoService
      ...
      .subscribe((res: HttpResponse<IEndereco[]>) => this.paginateEnderecos(res.body, res.headers));
  }
  ...
  protected paginateEnderecos(data: IEndereco[], headers: HttpHeaders) {
