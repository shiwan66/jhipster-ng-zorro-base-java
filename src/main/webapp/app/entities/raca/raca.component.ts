...
export class RacaComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.racaService
      ...
      .subscribe((res: HttpResponse<IRaca[]>) => this.paginateRacas(res.body, res.headers));
  }
  ...
  registerChangeInRacas() {
    this.eventSubscriber = this.eventManager.subscribe('racaListModification', () => this.loadAll());
  }
  ...
  protected paginateRacas(data: IRaca[], headers: HttpHeaders) {
